...
_lr_productions = [
  ...
  ('expression -> expression PLUS term','expression',3,'p_expression_plus','programa_final.py',71),
  ('expression -> expression MINUS term','expression',3,'p_expression_minus','programa_final.py',75),
  ('expression -> term','expression',1,'p_expression_term','programa_final.py',79),
  ('term -> term TIMES factor','term',3,'p_term_times','programa_final.py',83),
  ('term -> term DIVIDE factor','term',3,'p_term_divide','programa_final.py',87),
  ('term -> factor','term',1,'p_term_factor','programa_final.py',91),
  ('factor -> NUMBER','factor',1,'p_factor_num','programa_final.py',95),
  ('factor -> LPAREN expression RPAREN','factor',3,'p_factor_expr','programa_final.py',99),
]
